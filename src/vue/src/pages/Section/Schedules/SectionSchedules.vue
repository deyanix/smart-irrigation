    ...
    <AppPageHeader>
      <template #breadcrumbs>
        <AppBreadcrumbs class="col">
          ...
          <AppBreadcrumbsEl> Zaplanowane nawodnienia </AppBreadcrumbsEl>
        </AppBreadcrumbs>
      </template>
    </AppPageHeader>
...
import { useSectionSchedulesColumns } from 'pages/Section/Schedules/_composables/useSectionSchedulesColumns';
